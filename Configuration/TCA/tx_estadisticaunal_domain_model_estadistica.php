...
return [
    'ctrl' => [
        ...
        'searchFields' => 'nombre,nombre_display,descripcion,texto_protocolo,total,badge,alt_badge,desagregaciones,atributos,tipos_atr_desagregaciones',
        'iconfile' => 'EXT:estadistica_unal/Resources/Public/Icons/tx_estadisticaunal_domain_model_estadistica.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, nombre, nombre_display, descripcion, texto_protocolo, total, badge, alt_badge, desagregaciones, atributos, tipos_atr_desagregaciones',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, nombre, nombre_display, descripcion, texto_protocolo, total, badge, alt_badge, desagregaciones, atributos, tipos_atr_desagregaciones, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
        ...
        'total' => [
            'exclude' => true,
            'label' => 'LLL:EXT:estadistica_unal/Resources/Private/Language/locallang_db.xlf:tx_estadisticaunal_domain_model_estadistica.total',
            'config' => [
                'type' => 'text',
                'cols' => 40,
                'rows' => 15,
