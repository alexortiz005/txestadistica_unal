...
return [
    'ctrl' => [
        ...
        'searchFields' => 'nombre,nombre_display,texto_protocolo,badge,alt_badge,desagregaciones,atributos,tipos_atr_desagregaciones,indicadores',
        'iconfile' => 'EXT:estadistica_unal/Resources/Public/Icons/tx_estadisticaunal_domain_model_estadistica.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, nombre, nombre_display, texto_protocolo, badge, alt_badge, desagregaciones, atributos, tipos_atr_desagregaciones, indicadores',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, nombre, nombre_display, texto_protocolo, badge, alt_badge, desagregaciones, atributos, tipos_atr_desagregaciones, indicadores, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
