 ...
 */
class TipoAtrDesagregacionTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
    /**
     * @var \Unal\EstadisticaUnal\Domain\Model\TipoAtrDesagregacion
     */
    ...
    {
        parent::setUp();
        $this->subject = new \Unal\EstadisticaUnal\Domain\Model\TipoAtrDesagregacion();
    }
