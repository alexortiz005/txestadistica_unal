 ...
 */
class TipoAtrEstadisticaTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
    /**
     * @var \Unal\EstadisticaUnal\Domain\Model\TipoAtrEstadistica
     */
    ...
    {
        parent::setUp();
        $this->subject = new \Unal\EstadisticaUnal\Domain\Model\TipoAtrEstadistica();
    }
