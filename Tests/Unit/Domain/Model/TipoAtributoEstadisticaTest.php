 ...
 */
class TipoAtributoEstadisticaTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
    /**
     * @var \Unal\EstadisticaUnal\Domain\Model\TipoAtributoEstadistica
     */
    ...
    {
        parent::setUp();
        $this->subject = new \Unal\EstadisticaUnal\Domain\Model\TipoAtributoEstadistica();
    }
